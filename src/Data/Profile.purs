...
module RoutingPOC.Data.Profile where

import Prelude

import RoutingPOC.Data.Email (Email)
import RoutingPOC.Data.Email as Email
import RoutingPOC.Data.Username (Username)
import RoutingPOC.Data.Username as Username
...
authorCodec mbUsername = mapCodec to from codec
  ...
  to { username, bio, following } = pure do
    let mkAuthor = { username, bio, relation: _ }
  ...
  from { username, bio, relation } = do
    let mkAuthorJson = { username, bio, following: _ }
